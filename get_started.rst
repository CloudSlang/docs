...
-  `Download <https://github.com/CloudSlang/cloud-slang/releases/tag/cloudslang-0.9.60.0>`__
...
-  See an `overview <https://github.com/CloudSlang/cloud-slang-content/blob/cloud-slang-content-0.9.60/DOCS.md>`__
