The CloudSlang Build Tool checks the syntactic validity of CloudSlang files, their adherence to many of the [best practices](cloudslang_best_practices.md) and runs their associated tests. 
